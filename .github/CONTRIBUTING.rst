...
Report bugs at https://github.com/Midnighter/metanetx-post/issues.
...
metanetx-post could always use more documentation, whether as part of the
...
https://github.com/Midnighter/metanetx-post/issues.
...
Ready to contribute? Here's how to set up metanetx-post for
local development.

1. Fork the https://github.com/Midnighter/metanetx-post
   repository on GitHub.
2. Clone your fork locally

   .. code-block:: console
   
       git clone git@github.com:your_name_here/metanetx-post.git
